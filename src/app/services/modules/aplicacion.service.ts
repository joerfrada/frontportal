...
export class AplicacionService {
  ...
  private apiGetTipoAplicaciones = this.api.getBaseUrl + "aplicacion/getTipoAplicaciones";
  ...
  public getTipoAplicaciones(): Observable<any> {
    return this.http.get<any>(this.apiGetTipoAplicaciones, this.api.getHttpOptions('g'))
    .pipe(retry(1), catchError(this.api.errorHandle));
  }
}
